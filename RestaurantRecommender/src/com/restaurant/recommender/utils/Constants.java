...
public class Constants {	
	...
	public static final String API_URL = "http://192.168.4.237/restaurant_recommender/api.php?"; //"http://10.15.1.243/restaurant_recommender/api.php?";//"http://192.168.4.237:8080/RestaurantRecommenderAPI";
